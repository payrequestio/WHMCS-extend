    ...
    <div class="tab-pane fade in active" id="tabOverview">
        ...
        <div class="row">
            <div class="col-sm-offset-1 col-sm-5">
                <h4><strong>{$LANG.clientareahostingdomain}:</strong></h4> <a href="http://
...
{php}
$nextduedate = $template->getVariable('nextduedate')->value;
$nextduedate = str_replace("/","-", $nextduedate);
if ((strtotime($nextduedate) - time()) < 2592000) {
{/php}
...
<strong> Je domeinnaam verloopt binnen 30 dagen </strong> ( {$nextduedate} )<br> 
Hostingwalk hanteert een opzegtermijn van 30 dagen het is daarom niet meer mogelijk om je domeinnaam verlenging te annuleren.
</div>
